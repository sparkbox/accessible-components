...
<div class='accordion'>
  <div class='accordion-section'>
    <h3 class='accordion-header collapsed'>
      <button id='sect1-button' type='button' role='button' aria-expanded='false' aria-controls='sect1-panel' type='button'>
        Section1
    ...
    <div id='sect1-panel' class="tab-panel" role='region' aria-labelledby='sect1-button'>
  ...
  <div class='accordion-section'>
    <h3 class='accordion-header collapsed'>
      <button id='sect2-button' type='button' role='button' aria-expanded='false' aria-controls='sect2-content'>
        Section2
        <svg class='dropdown-arrow' height='10' width='10'>
          <path class="arrow" d="m 0 0 l 10 0 l  -5 10 z" />
        </svg>
      </button>
    </h3>
