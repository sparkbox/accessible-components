      ...
      <div className="home">
        ...
        <div className="components">
          <ul className="components-grid">
            ...
            <li className="components-grid__item components-grid__item--max-scott"><img src="/max-grid.svg" alt="Illustration of cute small white terrier dog with tongue out and head turned to the left looking like he is curious" /></li>
          </ul>
        </div>
      </div>
    </Layout>
